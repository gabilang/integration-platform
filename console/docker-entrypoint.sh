...
window._env_ = {
  ...
  VITE_CORE_DP_API_BASE_URL: "${VITE_CORE_DP_API_BASE_URL:-/platform-api-service/wso2cloud-dp}",
...
echo "✅ Nginx proxy configured: /platform-api-service/ -> ${PLATFORM_API_PROXY_URL}/platform-api-service/"

echo "📋 Configuration Summary:"
echo "   Platform IDP URL: ${VITE_PLATFORM_IDP_URL:-[NOT SET]}"
echo "   Core DP API Base URL: ${VITE_CORE_DP_API_BASE_URL:-/platform-api-service/wso2cloud-dp}"
